...
This repository includes an enhanced version of LittleProxy with a built-in web-based admin interface, CSV-backed user authentication, per-user bandwidth controls, and domain blacklist support.
...
This fork also includes a managed admin launcher for proxy users and blacklist management. Build and run it with:
...
Then open the admin panel at `http://localhost:9090/`.

This fork adds the following features:

- Web-based admin interface for managing proxy users
- CSV-backed user authentication and user data storage
- Per-user bandwidth throttling
- Per-user domain blacklist support
- Proxy authentication handling that supports filter-based blocking
